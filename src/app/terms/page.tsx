...
export const metadata = {
  ...
  description: "Terms of Service for ChiefOS",
};
    ...
    <div className="max-w-4xl mx-auto py-24 px-6 sm:px-12 prose prose-invert prose-blue">
      ...
      <section className="mb-12">
        ...
        <p className="text-gray-300 leading-relaxed mb-4">
          By accessing or using ChiefOS at fluxmail.dev (the "Service"), you agree to be bound by these Terms of Service. If you disagree with any part of the terms, you may not access the Service.
        </p>
      </section>
      ...
      <section className="mb-12">
        ...
        <p className="text-gray-300 leading-relaxed mb-4">
          ChiefOS is an email-driven cognitive assistant that integrates with your Google Workspace accounts (Gmail and Calendar) to help manage emails, generate briefings, and assist with scheduling. We use artificial intelligence models to process data strictly for these purposes.
        </p>
      </section>
      ...
      <section className="mb-12">
        ...
        <p className="text-gray-300 leading-relaxed mb-4">
          To use ChiefOS, you must grant us access to your Google account. By doing so, you authorize us to read, analyze, and (when requested by you) send emails and create calendar events on your behalf.
        </p>
        <p className="text-gray-300 leading-relaxed mb-4">
      ...
      <section className="mb-12">
        ...
        <p className="text-gray-300 leading-relaxed mb-4">
          In no event shall ChiefOS, nor its directors, employees, partners, agents, suppliers, or affiliates, be liable for any indirect, incidental, special, consequential or punitive damages, including without limitation, loss of profits, data, use, goodwill, or other intangible losses, resulting from your access to or use of or inability to access or use the Service.
        </p>
      </section>
